...
<%@ page import="model.ComentariosPubliVO"%>
...
<% String start = request.getParameter("start");
   ...
   ArrayList<ComentariosPubliVO> comentarios = (ArrayList<ComentariosPubliVO>)request.getSession().getAttribute("comentarios");
%>
...
<body id="page-top" class="bg-dark">
	...
	<div class="row my-4 mx-2 justify-content-center">
	    ...
	    <div class="col-6">
	    	...
	    	<!-- Publicacion referente -->
	        <div class="card shadow px-2 mb-4">
	            <h5 class="mx-5 mt-4"> Publicación </h5>
                <hr>
                <div id="<%= publicacionActual.getId() %>" class="mx-5 my-4">
	        		<h4> <%= publicacionActual.getNombre() %> </h4>	
	        		<p> <%= publicacionActual.getDescripcion() %> </p>
	        	</div>
	        </div>
	        ...
	        <div class="card shadow px-4 mb-4">
	            <div class="card-body">
                	<form action="SubirComentarioP" method="post">
	                	<div class="row d-flex align-items-center">
	                		<div class="col-9 mx-3">
	                			<input class="form-control rounded-3" required type="text" name="descripcion" placeholder="Comenta tu punto de vista con respecto a la publicación...">
	                		</div>
	                		<div class="col mx-3">
	        ...
	        <div class="card shadow px-2 my-4">
	        	...
	        	<% int count=0; 
	        	   if (comentarios.size() > 0) { %>
		        	<% for (ComentariosPubliVO c:comentarios) { 
		        	       count++; %>
	        ...
	        <div class="row my-4 justify-content-center">
	        	<div class="col">
	        		<div class="card shadow px-2 mb-4">
	        			<div style="text-align:center" class="card-body">
	        				<a <% if (startAsInt>1) { %> href="MostrarComentariosP?start=<%=startAsInt-endAsInt%>&end=<%=endAsInt%>" <% } %> > 
	        	...
	        	<div class="col">
	        		<div class="card shadow px-2 mb-4">
	        			<div style="text-align:center" class="card-body">
	        				<a href="Publicaciones.jsp#<%= publicacionActual.getId() %>" > 
	        	...
	        	<div class="col">
	        		<div class="card shadow px-2 mb-4">
	        			<div style="text-align:center" class="card-body">
	        				<a <% if (endAsInt==count) { %> href="MostrarComentariosP?start=<%=startAsInt+endAsInt%>&end=<%=endAsInt%>" <% } %> > 
