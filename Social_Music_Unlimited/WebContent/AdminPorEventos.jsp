	    ...
	    <div class="col-6">
	            ...
	            <div class="card-body text-center" style="display:inline-block">
	                ...
	                <div class="row text-center" >
	                    ...
	                    <form class="col" action="IniciarEventos" method="post">
	                    	<input class="btn btn-sel rounded-5 mx-2 my-1" required type="submit" value="por Evento">
	                    </form>
	        ...
	        <div class="row my-4 justify-content-center">
	        	<div class="col">
	        		<div class="card shadow px-2 mb-4">
	        			<div style="text-align:center" class="card-body">
	        				<a <% if (startAsInt>1) { %> href="MostrarEventosAdmin?start=<%=startAsInt-endAsInt%>&end=<%=endAsInt%>" <% } %> > 
	        	...
	        	<div class="col">
	        		<div class="card shadow px-2 mb-4">
	        			<div style="text-align:center" class="card-body">
	        				<a <% if (endAsInt==count) { %> href="MostrarEventosAdmin?start=<%=startAsInt+endAsInt%>&end=<%=endAsInt%>" <% } %> > 
